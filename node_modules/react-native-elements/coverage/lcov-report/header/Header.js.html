...
&nbsp;
const ALIGN_STYLE = <span class="cstat-no" title="statement not covered" >{</span>
  left: 'flex-start',
  right: 'flex-end',
  center: 'center',
};
&nbsp;
const Children = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >({</span> style, placement, children }) =&gt; (</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Children.propTypes = {</span>
...
<span class="fstat-no" title="function not covered" >  re</span>nder() {
    const {
      ...
      children,
      linearGradientProps,
      ViewComponent = <span class="branch-0 cbranch-no" title="branch not covered" >linearGradientProps &amp;&amp; global.Expo</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Header.propTypes = {</span>
  placement: PropTypes.oneOf(['left', 'center', 'right']),
...
&nbsp;
<span class="cstat-no" title="statement not covered" >Header.defaultProps = {</span>
  placement: 'center',
  children: [],
};
&nbsp;
