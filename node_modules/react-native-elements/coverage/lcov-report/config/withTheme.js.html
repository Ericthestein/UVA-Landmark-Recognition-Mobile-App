...
<html lang="en">
<head>
    <title>Code coverage report for config/withTheme.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">config</a> withTheme.js
    </h1>
    <div class='clearfix'>
        ...
        &lt;ThemeConsumer&gt;
          {context =&gt; {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!context) {
              const props = <span class="cstat-no" title="statement not covered" >{ ...rest, theme: DefaultTheme, children };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              return isClassComponent(WrappedComponent) ? (</span>
...
&nbsp;
  const name = themeKey
    ? `Themed.${themeKey}`
    : <span class="branch-1 cbranch-no" title="branch not covered" >`Themed.${WrappedComponent.displayName ||</span>
